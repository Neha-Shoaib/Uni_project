...
export default function page() {
  ...
  const currentProductId = "steel-cutlery-golden-001";
  ...
  const handleAddToCart = () => {
    for (let i = 0; i < amount; i++) {
      addToCart({
        ...
        title: "Steel Cutlery Set Golden",
        price: 890,
        image: "/gold-cutlery.PNG"   // ← Replace with your actual image
      });
    }
    Swal.fire({
      icon: "success",
      title: "Added to Cart!",
      html: `<strong>${amount} × Steel Cutlery Set Golden</strong>`,
      toast: true,
      position: "top-end",
      timer: 2000,
...
<Header/>
      {/* Product Detail – Steel Cutlery Set Golden */}
      <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16">
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          <Image
            src="/gold-cutlery.PNG"   // ← Your golden cutlery image here
            alt="Steel Cutlery Set Golden"
            width={800}
            height={800}
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Steel Cutlery Set Golden</h1>
          <p className="text-4xl text-amber-900 font-medium mb-10">Rs 890</p>

          <div className="space-y-8">
            <p className="text-gray-600 text-lg leading-relaxed">
              Elevate every meal with this luxurious 24-piece stainless steel cutlery set finished in radiant golden PVD coating. 
              Mirror-polished edges, perfect weight balance, and timeless elegance that transforms ordinary dining into a golden experience.
            </p>
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
                Real golden PVD coating (dishwasher safe)
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
                24-piece set (6× fork, spoon, knife, teaspoon)
              </li>
            </ul>

            {/* Dimensions */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Set Includes</h3>
              <div className="flex items-end justify-between max-w-md">
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Dinner Fork</p>
                  <p className="text-xl font-bold text-gray-900">21cm</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Dinner Knife</p>
                  <p className="text-xl font-bold text-gray-900">23cm</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Teaspoon</p>
                  <p className="text-xl font-bold text-gray-900">14cm</p>
                </div>
              </div>
            </div>
