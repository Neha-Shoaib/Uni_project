...
export default function page() {
  ...
  const currentProductId = "onyx-plant-pot-001";
  ...
  const handleAddToCart = () => {
    for (let i = 0; i < amount; i++) {
      addToCart({
        ...
        title: "The Onyx Plant Pot Collection",
        price: 650,
        image: "/onyx-plant-pot.PNG"   // ← Your hero image here
      });
    }
    Swal.fire({
      icon: "success",
      title: "Added to Cart!",
      html: `<strong>${amount} × The Onyx Plant Pot Collection</strong>`,
      toast: true,
      position: "top-end",
      timer: 2000,
  ...
  return (
    <div className="bg-stone-50 min-h-screen">
      ...
      {/* Navbar */}
<Header/>
      {/* Hero Product – The Onyx Plant Pot Collection */}
      <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16">
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          <Image
            src="/onyx-plant-pot.PNG"   // ← Drop your matte black pot image here
            alt="The Onyx Plant Pot Collection"
            width={800}
            height={800}
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">The Onyx Plant Pot Collection</h1>
          <p className="text-4xl text-amber-900 font-medium mb-10">Rs 650</p>

          <div className="space-y-8">
            <p className="text-gray-600 text-lg leading-relaxed">
              A trio of handcrafted matte black ceramic plant pots with subtle ribbed texture. 
              The deep onyx finish and architectural form bring quiet drama and modern elegance to any indoor jungle or minimalist shelf.
            </p>

            <ul className="space-y-3 text-gray-700">
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
                Premium stoneware with matte black glaze
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
            ...
            <div>
              ...
              <div className="flex items-end justify-between max-w-md">
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Small</p>
                  <p className="text-xl font-bold text-gray-900">14cm</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Medium</p>
                  <p className="text-xl font-bold text-gray-900">20cm</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Large</p>
                  <p className="text-xl font-bold text-gray-900">26cm</p>
                </div>
              </div>
            </div>
