...
export default function Chairs(){
    ...
    return(
            ...
            <div>
              ...
              <div className="bg-orange-900 text-white flex items-center justify-between px-4 py-2 relative">
  ...
  >
    <h2 className="text-2xl font-bold mb-2">The DUJUST Japanese Tea Pot, </h2>
    <p className="text-xl text-gray-900 mb-4">Rs 250</p>
    <p className="text-base text-gray-700 mb-6">
  A beautifully crafted ceramic teapot designed with a delicate floral pattern <br/>and a natural woven handle.
  Its timeless design blends traditional charm<br/> with modern simplicity, making it perfect for elegant tea
  gatherings or cozy everyday moments.
</p>
    ...
    <div className="mt-6 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
      ...
      <button
        ...
        className="w-full sm:w-auto px-20 max-w-[241px] h-[51px] bg-orange-900 text-white font-medium rounded hover:bg-orange-700"
      >
        Add to cart
      </button>
    </div>
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="!mt-8">
            ...
            <div className="mt-4">
              <Link href="javascript:void(0)" className="bg-indigo-900 hover:bg-blue-700 text-sm text-white font-medium py-3 px-6 tracking-wide rounded">Sign up</Link>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-end space-x-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm">
                ...
                <li>
                  <Link href="/components/furniture" className="hover:text-gray-400">
                    Furniture
                  </Link>
                </li>
                <li>
                  <Link href="/components/homeware" className="hover:text-gray-400">
                    Homeware
                  </Link>
                </li>
                <li>
                  <Link href="/components/plant-pots" className="hover:text-gray-400">
                    Plant pots
                  </Link>
                </li>
                <li>
