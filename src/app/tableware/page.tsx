...
export default function Tableware() {
  ...
  // Fetch all products (or filter by category if you have one)
  useEffect(() => {
  ...
  const handleAddToCart = () => {
    for (let i = 0; i < amount; i++) {
      addToCart({
        ...
        title: "The Candle Holders Set",
        price: 250,
        image: "/tableware1.PNG"
      });
    }
    Swal.fire({
      icon: "success",
      title: "Added to Cart!",
      html: `<strong>${amount} × The Candle Holders Set</strong>`,
      toast: true,
      position: "top-end",
      timer: 2000,
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-center flex-1">
            <ul className="flex space-x-8 text-sm font-medium text-gray-700">
              ...
              <li><Link href="/tableware" className="hover:text-amber-900 transition font-bold text-amber-900">Tableware</Link></li>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="space-y-8">
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              Perfect for creating a warm, sophisticated ambiance in any dining or living space.
            </p>

            <ul className="space-y-3 text-gray-700">
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
                Premium ceramic & metal finish
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-gray-800 rounded-full" />
            ...
            <div>
              ...
              <div className="flex items-end justify-between max-w-md">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-gray-900">15cm</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-gray-900">25cm</p>
                </div>
              </div>
            </div>
